package com.czc.blackblub.service;
...
import com.czc.blackblub.MainActivity;
import com.czc.blackblub.util.Utility;
import com.czc.blackblub.app.Constants;
import com.czc.blackblub.IMaskServiceInterface;
import com.czc.blackblub.R;

import com.czc.blackblub.util.ColorUtil;
    ...
    private void updateLayoutParams(int paramInt) {
        ...
        if (mLayout != null) {
            ...
            if (mYellowFilterAlpha > 0) {
                ...
                int blend = ColorUtil.blendColors(0xFFCB6D17, Color.TRANSPARENT, ratio);
                blend = ColorUtil.blendColors(Color.RED, blend, ratio / 3F);
                color = ColorUtil.blendColors(blend, color, ratio / 3F);

                color = ColorUtil.blendColors(0xFFCB6D17, Color.TRANSPARENT, ratio/3F);
            }

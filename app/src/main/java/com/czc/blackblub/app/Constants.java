...
public final class Constants {
    ...
    public static final String ACTION_UPDATE_STATUS = "com.czc.blackbulb.ACTION_UPDATE_STATUS";
    public static final String ACTION_ALARM_START = "com.czc.blackbulb.ALARM_ACTION_START";
    public static final String ACTION_ALARM_STOP = "com.czc.blackbulb.ALARM_ACTION_STOP";
    public static final String ACTION_TOGGLE = "com.czc.blackbulb.ACTION_TOGGLE";
